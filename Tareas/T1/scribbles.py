...
class Excavador(ABC):
    ...
    def encontrar_item(self):
        ...
        if encontrar_item: #esto pues an arena mojada siempre encontramos items
    ...
    def cavar(self):
        if self.descansando == False:
            metros_cavados = round((30/self.edad + (self.felicidad + 2*self.fuerza)/10) * \
                                    (1/10 * 7), 2) #ojo con esto mas adelante
...
gabe = ExcavadorDocencio(Nombre = "Gabe", Edad = 20, Energia = 60, Fuerza = 5, Suerte = 5, Felicidad = 5, Arena_actual = "arena1")
gabe2 = ExcavadorTareo(Nombre = "Gabe2", Edad = 20, Energia = 60, Fuerza = 5, Suerte = 5, Felicidad = 5, Arena_actual = "arena1")
gabe3 = ExcavadorHibrido(Nombre = "Gabe3", Edad = 20, Energia = 60, Fuerza = 10, Suerte = 10, Felicidad = 10, Arena_actual = "arena1")

item1 = Consumible(Nombre = "Pocion de Energia", Tipo = "Consumible", Descripcion = "Pocion que aumenta la energia", Energia = -8, Fuerza = 2, Suerte = 5, Felicidad = -2)
print(gabe3.energia, gabe3.felicidad, gabe3.fuerza, gabe3.suerte, gabe3.edad)
gabe3.consumir(item1)
print(gabe3.energia, gabe3.felicidad, gabe3.fuerza, gabe3.suerte, gabe3.edad)

alo = gabe.encontrar_item()
aloo = gabe2.encontrar_item()
alooo = gabe3.encontrar_item()
print(alo)
print(aloo)
print(alooo)