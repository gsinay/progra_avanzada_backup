...
__❌Animaciones__:   No implementado, los sprites se mueven discretamente en la grilla del front. Se eligió un único archivo para cada elemento del juego png de la carpeta sprites para representarlo. 
